...
{_x flyInHeight 30; _x setCombatMode 'RED'} forEach _airbluefight;
...
_wpP1 setWaypointStatements ["true","_airbluefight setCombatMode 'BLUE'"];
...
_wpP3 setWaypointBehaviour "AWARE";
...
_wpP4 setWaypointBehaviour "AWARE";
_wpP4 setWaypointSpeed "LIMITED";
